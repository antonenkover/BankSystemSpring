        ...
        <div class="agileits-top">
            <form action="create_account" method="post">
                ...
                <div id="ifYes" style="display:none">
                    ...
                    <input type="text" id="datepicker" name="start_date" placeholder="<fmt:message key="acc.start"/>"
                           required=""></br>
                    <input type="text" name="dep_dur" placeholder="<fmt:message key="credit_acc9"/>" required="">
                    <input type="submit" name="commit" value="Send">
                </div>
                <div id="ifNo" style="display:none">
                    <input class="text" type="text" name="deb" placeholder="<fmt:message key="credit_acc3"/>"
                           required=""></br>
                    <input class="text" type="text" name="login" placeholder="<fmt:message key="acc.percentage"/>"
                           required=""></br>
